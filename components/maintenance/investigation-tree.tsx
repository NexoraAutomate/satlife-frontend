...
function TreeNode({ node, onSelect }: { node: InvestigationTreeNode; onSelect?: (node: InvestigationTreeNode) => void }) {
...
export function InvestigationTree({ nodes, onSelect }: InvestigationTreeProps) {
